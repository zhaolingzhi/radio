...
- max_grad_norm - the maximum permissible norm of the gradient数字杭电
...
class PTBModel(object):
    ...
    def __init__(self, is_training, config):
        ...
        RNN_LAYERS = [{'num_units': 200}, {'num_units': 200}]
        cell=lstm_cells(RNN_LAYERS)
        ...
        # 带权重的交叉熵计算
        temp=tf.reshape(self._targets, [-1])
