...
Xd = cPickle.load(open("2016.04C.multisnr.pkl",'rb'))
...
model = Sequential()
#model.add(Reshape(2*128 , input_shape=in_shp))
model.add(LSTM(256,batch_input_shape=(512,2,128),return_sequences=True,name='LSTM1'))
model.add(Dropout(0.5))
model.add(LSTM(256,return_sequences=True,name='LSTM2')),
model.add(Dropout(0.5))
model.add(Flatten())
...
#model.add(Dropout(0.5))
model.add(Dense(len(classes),activation='softmax',name='softmax'))
